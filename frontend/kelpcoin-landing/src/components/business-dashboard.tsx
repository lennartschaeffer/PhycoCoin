...
export default function BusinessDashboard() {
  ...
  <p style="margin: 0 0 10px 0; font-size: 28px; color: #fbbf24; font-weight: bold;">${(businessStats.totalCO2Offset / 1000).toFixed(1)}t Nutrient</p>
  <p style="margin: 0 0 15px 0; font-size: 12px;">using local seaweed farming</p>
  <img src="data:image/svg+xml;base64,${btoa(new XMLSerializer().serializeToString(document.getElementById("qr-code-svg") || document.createElement("svg")))}" style="width: 64px; height: 64px; background: white; padding: 8px; border-radius: 8px;" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Total PhycoCoins Bought</p>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Total nutrient Offset</p>
                    ...
                    <table className="w-full">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="text-left py-3 px-4 font-semibold text-gray-700">PhycoCoins</th>
              ...
              <Card>
                ...
                <CardContent className="text-center space-y-4">
                  <div className="bg-gradient-to-br from-slate-800 to-slate-600 text-white p-6 rounded-lg">
                    <h3 className="text-lg font-bold mb-2">{businessInfo.name}</h3>
                    <p className="text-sm mb-4">This business offset</p>
                    <p className="text-3xl font-bold text-yellow-400">
                      {(businessStats.totalCO2Offset / 1000).toFixed(1)}t Nutrient
                    </p>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <Button variant="outline" className="w-full justify-start" onClick={downloadQRCode}>
                      <Download className="w-4 h-4 mr-2" />
                      Download QR Badge (PNG)
                    </Button>
                    <Button variant="outline" className="w-full justify-start" onClick={generateEmbedCode}>
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">QR Code Links To:</h4>
                    <p className="text-sm text-green-700 break-all">{impactPageUrl}</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 text-sm">
                A micro nutrient marketplace connecting seaweed farmers with local businesses for verified nutrient
                removal.
              </p>
            </div>
            <div>
