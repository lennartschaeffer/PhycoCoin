...
function HarvestPhotoCapture({
  ...
  onPhotoVerified,
  onPhotoTaken,
}: { harvestId: string; onPhotoVerified: () => void; onPhotoTaken: (file: File) => void }) {
    ...
    <div className="my-8">
      ...
      <div className="mb-6">
        <div className="text-center mb-2">
          ...
          <p className="text-sm text-gray-600">Include this code visible in your harvest photo</p>
        </div>
        <div className="p-6 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg border-2 border-blue-300">
          <div className="text-center">
            ...
            <div className="text-xs text-blue-100 mt-1">Include this code in your photo</div>
          </div>
        </div>
      </div>
      <div className="mb-4">
...
export default function FarmerSubmitHarvest() {
  ...
  useEffect(() => {
    const initializeData = async () => {
      ...
      await Promise.all([fetchLocationAutomatically(), fetchSensorDataAutomatically()])
            ...
            <Card className="w-full max-w-md">
              <CardContent className="pt-6">
                <div className="text-center space-y-4">
                  ...
                  <h3 className="text-lg font-semibold">Initializing Harvest Submission</h3>
                ...
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="font-mono text-lg">{latitude || "Detecting..."}</div>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <div className="text-sm text-gray-600">Longitude</div>
                      <div className="font-mono text-lg">{longitude || "Detecting..."}</div>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-white shadow-sm border border-gray-100">
              <CardHeader>
                ...
                <CardDescription>
                  Real-time environmental conditions automatically collected from your location
                </CardDescription>
              </CardHeader>
              <CardContent>
                {sensorData ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">Collecting environmental data...</p>
                  </div>
                )}
              </CardContent>
            </Card>
                    ...
                    {validationResult.isValid && (
                      <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="font-semibold text-yellow-800">PhycoCoins Reward</span>
                        </div>
                      ...
                      <div className="mt-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                          <div className="text-center p-3 bg-blue-50 rounded-lg">
                            ...
                            <div className="text-xs sm:text-sm text-gray-600">Nitrogen</div>
                          </div>
                          <div className="text-center p-3 bg-green-50 rounded-lg">
                            <div className="text-lg sm:text-xl font-bold text-green-600">
                              {validationResult.nutrientRemovals.P_kg} kg
                            </div>
                            <div className="text-xs sm:text-sm text-gray-600">Phosphorus</div>
                          </div>
                          <div className="text-center p-3 bg-gray-50 rounded-lg">
                            <div className="text-lg sm:text-xl font-bold text-gray-600">
                              {validationResult.nutrientRemovals.C_kg} kg
                            </div>
                            <div className="text-xs sm:text-sm text-gray-600">Carbon</div>
                          </div>
                        </div>
                      </div>
